...
import com.fetchRewards.example.dao.VersionCompImplWithAdditionalChecks.VersionCompImplWithAdditionalChecksException;
import com.fetchRewards.example.dao.VersionCompSimpleImpl.VersionCompSimpleImplException;

class VersionCompImplWithAdditionalChecksTest {
	private VersionComp tester = new VersionCompImplWithAdditionalChecks();
	@Test
	...
	private void checkError(String p_str1, String p_str2) {
		try {
			...
			assertThrows(VersionCompImplWithAdditionalChecksException.class, () -> {
			});
		}
		catch (VersionCompImplWithAdditionalChecksException e) {
